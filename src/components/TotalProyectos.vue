<template lang="">
   <div class="row my-3">
    ...
    <div class="col-6 text-end">
      <button @click="limpiarData" class="btn btn-info">Limpiar proyectos</button>
    </div>
   </div>
        ...
        <table class="table table-dark table-hover">
          ...
          <tbody>
            <tr v-for="(proyecto, index) in proyectos" :key="index">
              ...
              <th class="text-center"><button @click="removeData(index)" class="btn btn-warning">Borrar</button></th>
            </tr>
          </tbody>
        </table>
      </div>
...
<script>
    export default {
        props:  ['numeroProyectos', 'proyectos', 'cambiarEstado', 'limpiarData', 'removeData'], 
    };
</script>